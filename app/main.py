...
async def on_startup(dispatcher: Dispatcher):
    ...
    await bot.set_my_description(description=f"👋 Меня зовут Иван, я мастер по ремонту колясок и отец троих детей"
                                             f"\n\n🔍 Ещё выбираете? Найдем модель, которая реально подойдет под "
                                             f"Ваши жизненные условия (AI-подбор + мои видеорекомендации)"
                                             f"\n\n🛠 Уже купили? Поделюсь важными нюансами эксплуатации (80% поломок "
                                             f"происходит по вине владельцев колясок!)"
                                             f"\n\nПокажу, что нужно сделать сразу после покупки, а чего с коляской делать "
                                             f"категорически нельзя"
