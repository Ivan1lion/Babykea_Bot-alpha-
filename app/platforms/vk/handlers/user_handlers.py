...
async def _handle_blog(vk_id, peer_id, session, vk_api):
    ...
    text = (
        ...
        "(мое мнение о маркетинговых уловках и манипуляциях со стороны производителей детских колясок)\n\n"
    ...
    await _send(vk_api, peer_id, text,
                keyboard=vk_kb.blog_kb(),
                attachment=VK_UPLOADED_PHOTOS.get("for_blog.jpg")
                )
