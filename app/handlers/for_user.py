...
async def process_promo_code(
    ...
    # Проверяем, есть ли вообще имя у магазина (не None и не пустая строка)
    if mag_name:
        if raw_url:
        ...
        # 4. ФИНАЛЬНЫЙ ТЕКСТ (Если магазин именной)
        success_text = (
        ...
        # 4. ФИНАЛЬНЫЙ ТЕКСТ (Если имя магазина пустое / None)
        success_text = '✅ Проведена успешная активация по промокоду'
