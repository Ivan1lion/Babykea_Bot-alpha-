...
async def activation(call: CallbackQuery):
    ...
    await call.message.answer(
        "<b>Для активации функционала [Babykea] оплатите полный доступ ко всем разделам за 1900₽</b> "
        "\n(<u>bonus</u>: +50 запросов к AI-консультанту)"
        "\n\n<blockquote>🎁 <b>Есть флаер от магазина-партнера?</b> — нажмите «Ввести код активации» и получите бесплатный "
        "доступ к моим авторским видеорекомендациям и личным советам: как выбрать и не сломать коляску</blockquote>",
