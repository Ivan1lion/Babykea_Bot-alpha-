...
async def quiz_next(
    ...
    if profile.completed:
        ...
        await bot.send_animation(
            ...
            caption=(
                "✅ <b>Отлично! Данные приняты</b>\n\n"
                "На основе Ваших ответов я уже подготовил базу для поиска и рекомендаций. Я учел параметры из квиз-опроса которые "
                "Вы указали, чтобы рекомендации были максимально точными"
                "<blockquote>Вы всегда можете перепройти квиз для изменения Ваших исходных данных\n"
                "[Меню] >> [👤 Мой профиль]</blockquote>\n\n"
                "Остался последний шаг - получить доступ к функционалу [Babykea]"
            ),
